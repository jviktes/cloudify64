...
const LogActionsMenu: FunctionComponent<LogActionsMenuProps> = ({
    ...
    const exporttoPdf = () => {
        ...
        divContents=divContents+"<h2>Test details</h2>";
